...
\begin{theorem}[Extinction by noise]
    ...
    $
        ...
        \max 
            ...
            \right \}
    $,
        then the disease will exponentially extinguish with probability one.  
        That is, for any initial condition 
...
%
    ...
    second factor in \eqref{eqn:phi_difference_rewritten} also results 
    nonnegative.
...
\begin{theorem}
    ...
    \begin{equation}
        \limsup_{t \to \infty}
            \frac{1}{t}
            \ln(aI_V + b I_H) < (\mathcal{R}_0^S -1) <0 , \qquad a.s.,
    \end{equation}
...
%            &
    ...
    \begin{equation}
        ...
        = \mathcal{R}_0^D - 1.
    \end{equation}
    Taking $y := \dfrac{x}{2^n}$,  $n \in \mathbb{N}$, 
    %
    ...
    \begin{equation}\label{eqn:T_1_rzero_d}
         ...
         = \mathcal{R}_0 ^ D - 1 .
    \end{equation}
    Combining \eqref{eqn:ito_extinction_bound} and 
...
%
    ...
    $$
    that is, the disease will exponentially extinguishes 
